...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Message.circle'
        db.add_column(u'paloma_message', 'circle',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['paloma.Circle'], null=True, on_delete=models.SET_NULL),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Message.circle'
        db.delete_column(u'paloma_message', 'circle_id')
    ...
    models = {
        ...
        u'paloma.provision': {
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'YbPETwLP0gE5UGkgQTcP2hLzlAdjP2Co'", 'unique': 'True', 'max_length': '100'}),
            'short_secret': ('django.db.models.fields.CharField', [], {'default': "'sjjuvgV7'", 'unique': 'True', 'max_length': '10'}),
