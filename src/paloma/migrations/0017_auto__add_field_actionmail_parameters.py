...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ActionMail.parameters'
        db.add_column(u'paloma_actionmail', 'parameters',
                      self.gf('json_field.fields.JSONField')(default='null'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ActionMail.parameters'
        db.delete_column(u'paloma_actionmail', 'parameters')
    ...
    models = {
        ...
        u'paloma.actionmail': {
            ...
            'parameters': ('json_field.fields.JSONField', [], {'default': "'null'"}),
        ...
        u'paloma.provision': {
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'j8fGx1oOdwW9HRAITC2NkqRbQibse3ty'", 'unique': 'True', 'max_length': '100'}),
            'short_secret': ('django.db.models.fields.CharField', [], {'default': "'qzm2jgjC'", 'unique': 'True', 'max_length': '10'}),
