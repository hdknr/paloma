...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Publish.activated_at'
        db.add_column(u'paloma_publish', 'activated_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Publish.activated_at'
        db.delete_column(u'paloma_publish', 'activated_at')
    ...
    models = {
        ...
        u'paloma.provision': {
            ...
            'dt_expire': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 3, 0, 0)', 'null': 'True', 'blank': 'True'}),
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'DJ42NtpB0o35YyyNE1sQHs0aMPl5PVWO'", 'unique': 'True', 'max_length': '100'}),
            'short_secret': ('django.db.models.fields.CharField', [], {'default': "'hnIjLLgV'", 'unique': 'True', 'max_length': '10'}),
