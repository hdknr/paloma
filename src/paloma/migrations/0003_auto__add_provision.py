...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'paloma_provision', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('member', self.gf('django.db.models.fields.related.OneToOneField')(null=True, on_delete=models.SET_NULL, default=None, to=orm['paloma.Member'], blank=True, unique=True)),
            ('status', self.gf('django.db.models.fields.CharField')(max_length=24, db_index=True)),
            ('circle', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['paloma.Circle'], null=True, on_delete=models.SET_NULL, blank=True)),
            ...
            ('secret', self.gf('django.db.models.fields.CharField')(default='3n010ISu51lEMSFTGtxVxVeoYtgVufZE', unique=True, max_length=100)),
            ('short_secret', self.gf('django.db.models.fields.CharField')(default='62brvv7m', unique=True, max_length=10)),
        ...
        db.send_create_signal(u'paloma', ['Provision'])


    def backwards(self, orm):
        # Deleting model 'Provision'
        db.delete_table(u'paloma_provision')
    ...
    models = {
        ...
        u'paloma.enroll': {
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'OEMt3uKJgOxOpS7zx3MZkzTIvNkuziAo'", 'unique': 'True', 'max_length': '100'}),
            'short_secret': ('django.db.models.fields.CharField', [], {'default': "'2TkBfvoE'", 'unique': 'True', 'max_length': '10'}),
        ...
        u'paloma.provision': {
            ...
            'prospect': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'secret': ('django.db.models.fields.CharField', [], {'default': "'p7GpJO2DQX0B6ztBpOGbTvDnvcQHZ6rR'", 'unique': 'True', 'max_length': '100'}),
            'short_secret': ('django.db.models.fields.CharField', [], {'default': "'BDUtqPrG'", 'unique': 'True', 'max_length': '10'}),
