...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Circle.is_moderated'
        db.add_column(u'paloma_circle', 'is_moderated',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Circle.is_moderated'
        db.delete_column(u'paloma_circle', 'is_moderated')
    ...
    models = {
        ...
        u'paloma.provision': {
            ...
            'dt_expire': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 15, 0, 0)', 'null': 'True', 'blank': 'True'}),
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'v22FCUu4IO8QJAJsATtESuhObXVS2QEv'", 'unique': 'True', 'max_length': '100'}),
            'short_secret': ('django.db.models.fields.CharField', [], {'default': "'SXsDOdjn'", 'unique': 'True', 'max_length': '10'}),
