...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        orm.Membership.objects.all().update(is_admitted=True)
    ...
    models = {
        ...
        u'paloma.provision': {
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'DpMrjg0KSCVXZekYE1TmrXg5YiiPxy0i'", 'unique': 'True', 'max_length': '100'}),
            'short_secret': ('django.db.models.fields.CharField', [], {'default': "'v4uMa4dX'", 'unique': 'True', 'max_length': '10'}),
