...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'paloma_membership', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('member', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['paloma.Member'])),
            ('circle', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['paloma.Circle'])),
            ('is_admin', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'paloma', ['Membership'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'paloma_membership')
    ...
    models = {
        ...
        u'paloma.provision': {
            ...
            'dt_expire': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 9, 0, 0)', 'null': 'True', 'blank': 'True'}),
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'lPp7QI4fmv4F6X6pR6SLAEcMC4XA5baC'", 'unique': 'True', 'max_length': '100'}),
            'short_secret': ('django.db.models.fields.CharField', [], {'default': "'bc1QlsBD'", 'unique': 'True', 'max_length': '10'}),
