...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Mail.parameters'
        db.add_column(u'paloma_mail', 'parameters',
                      self.gf('json_field.fields.JSONField')(default='null'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Mail.parameters'
        db.delete_column(u'paloma_mail', 'parameters')
    ...
    models = {
        ...
        u'paloma.provision': {
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'5T667fGvWeKuEta5W1mTUQAc3V7vzlnX'", 'unique': 'True', 'max_length': '100'}),
            'short_secret': ('django.db.models.fields.CharField', [], {'default': "'dKeGgv50'", 'unique': 'True', 'max_length': '10'}),
