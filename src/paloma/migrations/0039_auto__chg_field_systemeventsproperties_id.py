...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Systemeventsproperties.id'
        db.alter_column(u'SystemEventsProperties', u'ID', self.gf('django.db.models.fields.AutoField')(primary_key=True, db_column=u'ID'))

    def backwards(self, orm):

        # Changing field 'Systemeventsproperties.id'
        db.alter_column(u'SystemEventsProperties', u'ID', self.gf('django.db.models.fields.IntegerField')(primary_key=True, db_column=u'ID'))
    ...
    models = {
        ...
        u'paloma.provision': {
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'5LKBlbcxbjwsFiOHboyHRjIHwwHWR6J2'", 'unique': 'True', 'max_length': '100'}),
            'short_secret': ('django.db.models.fields.CharField', [], {'default': "'oFqmwwLj'", 'unique': 'True', 'max_length': '10'}),
