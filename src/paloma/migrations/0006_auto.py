...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field circles on 'Publish'
        db.create_table(u'paloma_publish_circles', (
        ...
        db.create_unique(u'paloma_publish_circles', ['publish_id', 'circle_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field circles on 'Publish'
        db.delete_table('paloma_publish_circles')
    ...
    models = {
        ...
        u'paloma.enroll': {
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'vqrbHCDUFCta4ihnmXoMlyFx2rzUifM5'", 'unique': 'True', 'max_length': '100'}),
            'short_secret': ('django.db.models.fields.CharField', [], {'default': "'LqQIDAUE'", 'unique': 'True', 'max_length': '10'}),
        ...
        u'paloma.provision': {
            ...
            'prospect': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'secret': ('django.db.models.fields.CharField', [], {'default': "'zSXIlEg5tjVZIMG0vWAQsESefxtBYBOr'", 'unique': 'True', 'max_length': '100'}),
            'short_secret': ('django.db.models.fields.CharField', [], {'default': "'GDYTW3tV'", 'unique': 'True', 'max_length': '10'}),
