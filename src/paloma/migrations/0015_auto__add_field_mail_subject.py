...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'paloma_mail', 'subject',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'paloma_mail', 'subject')
    ...
    models = {
        ...
        u'paloma.provision': {
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'VDLmxJq2YklAcahhJbfvmZXzmbps2hmC'", 'unique': 'True', 'max_length': '100'}),
            'short_secret': ('django.db.models.fields.CharField', [], {'default': "'jE5cIcVA'", 'unique': 'True', 'max_length': '10'}),
