...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Mail.status'
        db.add_column(u'paloma_mail', 'status',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Mail.status'
        db.delete_column(u'paloma_mail', 'status')
    ...
    models = {
        ...
        u'paloma.provision': {
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'acP90KiNCroRzwUyS63ipXuSvCbd7fSK'", 'unique': 'True', 'max_length': '100'}),
            'short_secret': ('django.db.models.fields.CharField', [], {'default': "'PcxT1pTj'", 'unique': 'True', 'max_length': '10'}),
