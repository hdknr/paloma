...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'paloma_circle', 'description',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'paloma_circle', 'description')
    ...
    models = {
        ...
        u'paloma.provision': {
            ...
            'dt_expire': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 25, 0, 0)', 'null': 'True', 'blank': 'True'}),
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'sa2R9q4e5J7s5Ftvknc3IGEhNf0eZWkG'", 'unique': 'True', 'max_length': '100'}),
            'short_secret': ('django.db.models.fields.CharField', [], {'default': "'9pckRE6p'", 'unique': 'True', 'max_length': '10'}),
