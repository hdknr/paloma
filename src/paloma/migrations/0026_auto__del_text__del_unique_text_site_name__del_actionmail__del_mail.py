...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'ActionMail'
        db.delete_table(u'paloma_actionmail')
    ...
    def backwards(self, orm):
        ...
        # Adding model 'ActionMail'
        db.create_table(u'paloma_actionmail', (
            ...
            ('provision', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['paloma.Provision'], null=True, on_delete=models.SET_NULL)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('base_text', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['paloma.Text'], null=True, on_delete=models.SET_NULL)),
        ))
        db.send_create_signal(u'paloma', ['ActionMail'])
        ...
        db.create_table(u'paloma_mail', (
            ...
            ('circle', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['paloma.Circle'], null=True, blank=True)),
        ))
    ...
    models = {
        ...
        u'paloma.provision': {
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'bN2slylOmKdpJONe2SgsAKNltpalTF0G'", 'unique': 'True', 'max_length': '100'}),
            'short_secret': ('django.db.models.fields.CharField', [], {'default': "'dFgQE5kV'", 'unique': 'True', 'max_length': '10'}),
