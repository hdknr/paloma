...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Text', fields ['name']
        db.create_index(u'paloma_text', ['name'])


        # Changing field 'Site.url'
        db.alter_column(u'paloma_site', 'url', self.gf('django.db.models.fields.CharField')(default=datetime.datetime(2013, 4, 3, 0, 0), unique=True, max_length=150))

    def backwards(self, orm):
        # Removing index on 'Text', fields ['name']
        db.delete_index(u'paloma_text', ['name'])


        # Changing field 'Site.url'
        db.alter_column(u'paloma_site', 'url', self.gf('django.db.models.fields.CharField')(unique=True, max_length=150, null=True))
    ...
    models = {
        ...
        u'paloma.enroll': {
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'juzcxm4q3n3EhL4OV10KMFCVTuLnFosj'", 'unique': 'True', 'max_length': '100'}),
            'short_secret': ('django.db.models.fields.CharField', [], {'default': "'4iqJySdq'", 'unique': 'True', 'max_length': '10'}),
        ...
        u'paloma.provision': {
            ...
            'dt_commit': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'dt_expire': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 3, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'dt_try': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inviter': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['auth.User']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
            ...
            'prospect': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'secret': ('django.db.models.fields.CharField', [], {'default': "'6FOBbL6j8oLFvh1odx6i6dSywOtsPPdH'", 'unique': 'True', 'max_length': '100'}),
            'short_secret': ('django.db.models.fields.CharField', [], {'default': "'96OOZiZf'", 'unique': 'True', 'max_length': '10'}),
