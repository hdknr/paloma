...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'paloma.provision': {
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'XMlPKFfYYOqAPIPRDQIoQidVQTxANLla'", 'unique': 'True', 'max_length': '100'}),
            'short_secret': ('django.db.models.fields.CharField', [], {'default': "'Tnas0iZp'", 'unique': 'True', 'max_length': '10'}),
