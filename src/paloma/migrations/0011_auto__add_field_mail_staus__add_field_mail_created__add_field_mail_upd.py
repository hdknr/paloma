...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Mail.staus'
        db.add_column(u'paloma_mail', 'staus',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Mail.created'
        db.add_column(u'paloma_mail', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 4, 5, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Mail.updated'
        db.add_column(u'paloma_mail', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 4, 5, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Mail.smtpded'
        db.add_column(u'paloma_mail', 'smtpded',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Mail.staus'
        db.delete_column(u'paloma_mail', 'staus')

        # Deleting field 'Mail.created'
        db.delete_column(u'paloma_mail', 'created')

        # Deleting field 'Mail.updated'
        db.delete_column(u'paloma_mail', 'updated')

        # Deleting field 'Mail.smtpded'
        db.delete_column(u'paloma_mail', 'smtpded')
    ...
    models = {
        ...
        u'paloma.mail': {
            ...
            'smtpded': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'staus': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'text': ('django.db.models.fields.TextField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
        ...
        u'paloma.provision': {
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'F13PoLugIt97WEuFFTKECDc5vyQcR1g4'", 'unique': 'True', 'max_length': '100'}),
            'short_secret': ('django.db.models.fields.CharField', [], {'default': "'6SYFbVg2'", 'unique': 'True', 'max_length': '10'}),
