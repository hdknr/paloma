...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PublicationManager'
        db.create_table(u'paloma_publicationmanager', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'paloma', ['PublicationManager'])


    def backwards(self, orm):
        # Deleting model 'PublicationManager'
        db.delete_table(u'paloma_publicationmanager')
    ...
    models = {
        ...
        u'paloma.provision': {
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'bVj2VTKCi0mcjUZTV2MIIZumwxoIRLv9'", 'unique': 'True', 'max_length': '100'}),
            'short_secret': ('django.db.models.fields.CharField', [], {'default': "'smObHaUl'", 'unique': 'True', 'max_length': '10'}),
        ...
        u'paloma.publicationmanager': {
            'Meta': {'object_name': 'PublicationManager'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'paloma.publish': {
