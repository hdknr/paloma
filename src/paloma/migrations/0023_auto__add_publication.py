...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'paloma_publication', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('publish', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['paloma.Publish'])),
            ('message', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['paloma.Message'])),
        ))
        db.send_create_signal(u'paloma', ['Publication'])


    def backwards(self, orm):
        # Deleting model 'Publication'
        db.delete_table(u'paloma_publication')
    ...
    models = {
        ...
        u'paloma.provision': {
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'Vep1Sp6xU8fNgObPsp2KHNZ3mn0HNCBq'", 'unique': 'True', 'max_length': '100'}),
            'short_secret': ('django.db.models.fields.CharField', [], {'default': "'mDQTmFye'", 'unique': 'True', 'max_length': '10'}),
