...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Targetting'
        db.create_table(u'paloma_targetting', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('site', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['paloma.Site'])),
            ('targetter_content_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='targetter', to=orm['contenttypes.ContentType'])),
            ('targetter_object_id', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('mediator_content_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='mediator', to=orm['contenttypes.ContentType'])),
            ('mediator_object_id', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal(u'paloma', ['Targetting'])


    def backwards(self, orm):
        # Deleting model 'Targetting'
        db.delete_table(u'paloma_targetting')
    ...
    models = {
        ...
        u'paloma.provision': {
            ...
            'dt_expire': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 8, 0, 0)', 'null': 'True', 'blank': 'True'}),
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'wPfDzBKMFa557KQ19KJfWcpSXhB4pJul'", 'unique': 'True', 'max_length': '100'}),
            'short_secret': ('django.db.models.fields.CharField', [], {'default': "'iDS6zWjU'", 'unique': 'True', 'max_length': '10'}),
