...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Circle.is_secret'
        db.add_column(u'paloma_circle', 'is_secret',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Circle.is_secret'
        db.delete_column(u'paloma_circle', 'is_secret')
    ...
    models = {
        ...
        u'paloma.circle': {
            ...
            'is_secret': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        u'paloma.provision': {
            ...
            'dt_expire': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 16, 0, 0)', 'null': 'True', 'blank': 'True'}),
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'nAiSmaI6FDHQgD6r842GG78Jpx9oqc7y'", 'unique': 'True', 'max_length': '100'}),
            'short_secret': ('django.db.models.fields.CharField', [], {'default': "'H4SPAuU7'", 'unique': 'True', 'max_length': '10'}),
