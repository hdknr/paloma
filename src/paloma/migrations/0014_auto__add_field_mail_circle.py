...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Mail.circle'
        db.add_column(u'paloma_mail', 'circle',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['paloma.Circle'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Mail.circle'
        db.delete_column(u'paloma_mail', 'circle_id')
    ...
    models = {
        ...
        u'paloma.provision': {
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'KMwAqCsUFbAQGdJeinvDNQhFeZ4HQQRo'", 'unique': 'True', 'max_length': '100'}),
            'short_secret': ('django.db.models.fields.CharField', [], {'default': "'gqWWE3o5'", 'unique': 'True', 'max_length': '10'}),
