...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'paloma_site', 'url',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=150, unique=True, null=True, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Site.url'
        db.delete_column(u'paloma_site', 'url')
    ...
    models = {
        ...
        u'paloma.enroll': {
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'ViPPnaaRGpUzcIBuIrpAjZckge9lsxru'", 'unique': 'True', 'max_length': '100'}),
            'short_secret': ('django.db.models.fields.CharField', [], {'default': "'zHA8oUrP'", 'unique': 'True', 'max_length': '10'}),
        ...
        u'paloma.provision': {
            ...
            'prospect': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'secret': ('django.db.models.fields.CharField', [], {'default': "'M7sIv7onxqgZfMyI9WHMJ37HhTNfCwAc'", 'unique': 'True', 'max_length': '100'}),
            'short_secret': ('django.db.models.fields.CharField', [], {'default': "'qbM3S2vg'", 'unique': 'True', 'max_length': '10'}),
        ...
        u'paloma.site': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '100', 'db_index': 'True'}),
            'operators': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['auth.User']", 'symmetrical': 'False'}),
            'url': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '150', 'unique': 'True', 'null': 'True', 'db_index': 'True'})
        },
        u'paloma.text': {
