...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Mail.smtped'
        db.add_column(u'paloma_mail', 'smtped',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Mail.smtped'
        db.delete_column(u'paloma_mail', 'smtped')
    ...
    models = {
        ...
        u'paloma.provision': {
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'2Djy1bPcbvxZOny4JnxaXEuCAqrya2Sv'", 'unique': 'True', 'max_length': '100'}),
            'short_secret': ('django.db.models.fields.CharField', [], {'default': "'ciKSlILU'", 'unique': 'True', 'max_length': '10'}),
