...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Publish.site'
        db.alter_column(u'paloma_publish', 'site_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['paloma.Site']))

    def backwards(self, orm):

        # Changing field 'Publish.site'
        db.alter_column(u'paloma_publish', 'site_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['paloma.Site'], null=True))
    ...
    models = {
        ...
        u'paloma.enroll': {
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'HvaycK6pmlUV7JwpzOCuMBQR3YFenl1D'", 'unique': 'True', 'max_length': '100'}),
            'short_secret': ('django.db.models.fields.CharField', [], {'default': "'TTycJhRM'", 'unique': 'True', 'max_length': '10'}),
        ...
        u'paloma.provision': {
            ...
            'prospect': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'secret': ('django.db.models.fields.CharField', [], {'default': "'GFTSZON36eLq1etoJx8GqAuVQHTdK5Ch'", 'unique': 'True', 'max_length': '100'}),
            'short_secret': ('django.db.models.fields.CharField', [], {'default': "'5uqr24r7'", 'unique': 'True', 'max_length': '10'}),
