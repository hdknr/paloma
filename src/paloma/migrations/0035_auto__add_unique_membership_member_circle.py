...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Membership', fields ['member', 'circle']
        db.create_unique(u'paloma_membership', ['member_id', 'circle_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Membership', fields ['member', 'circle']
        db.delete_unique(u'paloma_membership', ['member_id', 'circle_id'])
    ...
    models = {
        ...
        u'paloma.provision': {
            ...
            'dt_expire': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 12, 0, 0)', 'null': 'True', 'blank': 'True'}),
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'89zpT9zMgbtNrjIPYErK6l3P8KJK17sP'", 'unique': 'True', 'max_length': '100'}),
            'short_secret': ('django.db.models.fields.CharField', [], {'default': "'vz9Gw4GN'", 'unique': 'True', 'max_length': '10'}),
