...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'paloma_template', (
            ...
            ('text', self.gf('django.db.models.fields.TextField')(default='', max_length=100)),
        ))
        db.send_create_signal(u'paloma', ['Template'])

        # Adding unique constraint on 'Template', fields ['site', 'name']
        db.create_unique(u'paloma_template', ['site_id', 'name'])

        # Adding model 'Message'
        db.create_table(u'paloma_message', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('template', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['paloma.Text'], null=True, on_delete=models.SET_NULL)),
            ('member', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['paloma.Member'], null=True, on_delete=models.SET_NULL)),
            ('mail_message_id', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100, db_index=True)),
            ('recipient', self.gf('django.db.models.fields.EmailField')(default=None, max_length=50, null=True, blank=True)),
            ('subject', self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True)),
            ...
            ('smtped', self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True)),
            ('parameters', self.gf('json_field.fields.JSONField')(default='null', null=True, blank=True)),
        ))
        db.send_create_signal(u'paloma', ['Message'])


    def backwards(self, orm):
        # Removing unique constraint on 'Template', fields ['site', 'name']
        db.delete_unique(u'paloma_template', ['site_id', 'name'])

        # Deleting model 'Template'
        db.delete_table(u'paloma_template')
    ...
    models = {
        ...
        u'paloma.message': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mail_message_id': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '100', 'db_index': 'True'}),
            'member': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['paloma.Member']", 'null': 'True', 'on_delete': 'models.SET_NULL'}),
            'parameters': ('json_field.fields.JSONField', [], {'default': "'null'", 'null': 'True', 'blank': 'True'}),
            'recipient': ('django.db.models.fields.EmailField', [], {'default': 'None', 'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'smtped': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'status': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'subject': ('django.db.models.fields.TextField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'template': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['paloma.Text']", 'null': 'True', 'on_delete': 'models.SET_NULL'}),
            'text': ('django.db.models.fields.TextField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
        u'paloma.provision': {
            ...
            'dt_expire': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 7, 0, 0)', 'null': 'True', 'blank': 'True'}),
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'q5wfxma5Oq56NrPBbRFF5th4Te2TaBnm'", 'unique': 'True', 'max_length': '100'}),
            'short_secret': ('django.db.models.fields.CharField', [], {'default': "'RiQAtTbk'", 'unique': 'True', 'max_length': '10'}),
