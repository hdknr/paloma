...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'paloma_template', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Template.name'
        db.alter_column(u'paloma_template', 'name', self.gf('django.db.models.fields.CharField')(max_length=20))
    ...
    models = {
        ...
        u'paloma.message': {
            ...
            'parameters': ('json_field.fields.JSONField', [], {'default': "u'null'", 'null': 'True', 'blank': 'True'}),
        ...
        u'paloma.provision': {
            ...
            'dt_expire': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 27, 0, 0)', 'null': 'True', 'blank': 'True'}),
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'SZaXCSwCGW51J7nyGtec9pSpbSbKTxRA'", 'unique': 'True', 'max_length': '100'}),
            'short_secret': ('django.db.models.fields.CharField', [], {'default': "'3mVsnyq1'", 'unique': 'True', 'max_length': '10'}),
