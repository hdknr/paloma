...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'Systemeventsproperties'
        db.delete_table(u'SystemEventsProperties')

        # Adding model 'Systemeventsproperty'
        db.create_table(u'SystemEventsProperties', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True, db_column=u'ID')),
            ('systemeventid', self.gf('django.db.models.fields.IntegerField')(null=True, db_column=u'SystemEventID', blank=True)),
            ('paramname', self.gf('django.db.models.fields.CharField')(max_length=255L, db_column=u'ParamName', blank=True)),
            ('paramvalue', self.gf('django.db.models.fields.TextField')(db_column=u'ParamValue', blank=True)),
        ))
        db.send_create_signal(u'paloma', ['Systemeventsproperty'])

        # Adding model 'Systemevent'
        db.create_table(u'SystemEvents', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True, db_column=u'ID')),
            ('customerid', self.gf('django.db.models.fields.BigIntegerField')(null=True, db_column=u'CustomerID', blank=True)),
            ('receivedat', self.gf('django.db.models.fields.DateTimeField')(null=True, db_column=u'ReceivedAt', blank=True)),
            ('devicereportedtime', self.gf('django.db.models.fields.DateTimeField')(null=True, db_column=u'DeviceReportedTime', blank=True)),
            ('facility', self.gf('django.db.models.fields.IntegerField')(null=True, db_column=u'Facility', blank=True)),
            ('priority', self.gf('django.db.models.fields.IntegerField')(null=True, db_column=u'Priority', blank=True)),
            ('fromhost', self.gf('django.db.models.fields.CharField')(max_length=60L, db_column=u'FromHost', blank=True)),
            ('message', self.gf('django.db.models.fields.TextField')(db_column=u'Message', blank=True)),
            ('ntseverity', self.gf('django.db.models.fields.IntegerField')(null=True, db_column=u'NTSeverity', blank=True)),
            ('importance', self.gf('django.db.models.fields.IntegerField')(null=True, db_column=u'Importance', blank=True)),
            ('eventsource', self.gf('django.db.models.fields.CharField')(max_length=60L, db_column=u'EventSource', blank=True)),
            ('eventuser', self.gf('django.db.models.fields.CharField')(max_length=60L, db_column=u'EventUser', blank=True)),
            ('eventcategory', self.gf('django.db.models.fields.IntegerField')(null=True, db_column=u'EventCategory', blank=True)),
            ('eventid', self.gf('django.db.models.fields.IntegerField')(null=True, db_column=u'EventID', blank=True)),
            ('eventbinarydata', self.gf('django.db.models.fields.TextField')(db_column=u'EventBinaryData', blank=True)),
            ('maxavailable', self.gf('django.db.models.fields.IntegerField')(null=True, db_column=u'MaxAvailable', blank=True)),
            ('currusage', self.gf('django.db.models.fields.IntegerField')(null=True, db_column=u'CurrUsage', blank=True)),
            ('minusage', self.gf('django.db.models.fields.IntegerField')(null=True, db_column=u'MinUsage', blank=True)),
            ('maxusage', self.gf('django.db.models.fields.IntegerField')(null=True, db_column=u'MaxUsage', blank=True)),
            ('infounitid', self.gf('django.db.models.fields.IntegerField')(null=True, db_column=u'InfoUnitID', blank=True)),
            ('syslogtag', self.gf('django.db.models.fields.CharField')(max_length=60L, db_column=u'SysLogTag', blank=True)),
            ('eventlogtype', self.gf('django.db.models.fields.CharField')(max_length=60L, db_column=u'EventLogType', blank=True)),
            ('genericfilename', self.gf('django.db.models.fields.CharField')(max_length=60L, db_column=u'GenericFileName', blank=True)),
            ('systemid', self.gf('django.db.models.fields.IntegerField')(null=True, db_column=u'SystemID', blank=True)),
        ))
        db.send_create_signal(u'paloma', ['Systemevent'])
    ...
    def backwards(self, orm):
        ...
        db.send_create_signal(u'paloma', ['Systemevents'])

        # Adding model 'Systemeventsproperties'
        db.create_table(u'SystemEventsProperties', (
            ('paramvalue', self.gf('django.db.models.fields.TextField')(db_column=u'ParamValue', blank=True)),
            ('systemeventid', self.gf('django.db.models.fields.IntegerField')(null=True, db_column=u'SystemEventID', blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True, db_column=u'ID')),
        ...
        db.send_create_signal(u'paloma', ['Systemeventsproperties'])

        # Deleting model 'Systemeventsproperty'
        db.delete_table(u'SystemEventsProperties')
    ...
    models = {
        ...
        u'paloma.membership': {
            'Meta': {'unique_together': "(('member', 'circle'),)", 'object_name': 'Membership'},
        ...
        u'paloma.provision': {
            ...
            'dt_expire': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 23, 0, 0)', 'null': 'True', 'blank': 'True'}),
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'ZVl1yPjsEVHHdLwkdy9qIz19dsW2xKWW'", 'unique': 'True', 'max_length': '100'}),
            'short_secret': ('django.db.models.fields.CharField', [], {'default': "'3qZeqkiw'", 'unique': 'True', 'max_length': '10'}),
        ...
        u'paloma.publish': {
            ...
            'activated_at': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
        ...
        u'paloma.systemevent': {
            'Meta': {'object_name': 'Systemevent', 'db_table': "u'SystemEvents'"},
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True', 'db_column': "u'ID'"}),
        ...
        u'paloma.systemeventsproperty': {
            'Meta': {'object_name': 'Systemeventsproperty', 'db_table': "u'SystemEventsProperties'"},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True', 'db_column': "u'ID'"}),
