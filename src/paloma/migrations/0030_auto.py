...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'paloma.provision': {
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'uRg3bgStGHawrzmr9uXfIvf1vsHIEX7T'", 'unique': 'True', 'max_length': '100'}),
            'short_secret': ('django.db.models.fields.CharField', [], {'default': "'uyG33SUO'", 'unique': 'True', 'max_length': '10'}),
