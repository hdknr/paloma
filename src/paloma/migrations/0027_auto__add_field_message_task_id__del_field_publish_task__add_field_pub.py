...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Message.task_id'
        db.add_column(u'paloma_message', 'task_id',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=40, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Publish.task'
        db.delete_column(u'paloma_publish', 'task')

        # Adding field 'Publish.task_id'
        db.add_column(u'paloma_publish', 'task_id',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=40, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Message.task_id'
        db.delete_column(u'paloma_message', 'task_id')

        # Adding field 'Publish.task'
        db.add_column(u'paloma_publish', 'task',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=100, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Publish.task_id'
        db.delete_column(u'paloma_publish', 'task_id')
    ...
    models = {
        ...
        u'paloma.provision': {
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'OjYv9i5pKBvhHJo6VaAZnw4ZlBZO3nvD'", 'unique': 'True', 'max_length': '100'}),
            'short_secret': ('django.db.models.fields.CharField', [], {'default': "'uHf1xj87'", 'unique': 'True', 'max_length': '10'}),
