...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Message.template'
        db.alter_column(u'paloma_message', 'template_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['paloma.Template'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):

        # Changing field 'Message.template'
        db.alter_column(u'paloma_message', 'template_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['paloma.Text'], null=True, on_delete=models.SET_NULL))
    ...
    models = {
        ...
        u'paloma.provision': {
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'kTJW1drLG1liwQXPzYJQ9UiGUJVQoPsv'", 'unique': 'True', 'max_length': '100'}),
            'short_secret': ('django.db.models.fields.CharField', [], {'default': "'e3f809dr'", 'unique': 'True', 'max_length': '10'}),
