...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Message.checked'
        db.add_column(u'paloma_message', 'checked',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Message.checked'
        db.delete_column(u'paloma_message', 'checked')
    ...
    models = {
        ...
        u'paloma.provision': {
            ...
            'dt_expire': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 12, 0, 0)', 'null': 'True', 'blank': 'True'}),
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'YaFFvPdHREyeftSCnyT7Utb5MTkKK47g'", 'unique': 'True', 'max_length': '100'}),
            'short_secret': ('django.db.models.fields.CharField', [], {'default': "'Rxjyivnq'", 'unique': 'True', 'max_length': '10'}),
